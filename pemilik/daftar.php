...
<body>
    ...
    <div class="header border-bottom-1 border border-primary">
        <nav class="navbar navbar-expand-lg" style="background-color: #e3f2fd;">
            <div class="container-fluid">
                ...
                <a class="navbar-brand fw-bold" href="#" style="color: #4e5aa8;">NYEWA</a>
    ...
    <div class="container my-5 p-4 border border-primary" style="background-color: #e3f2fd;">
        <div class="login row justify-content-md-center">
            <h4 class="text-center">Daftar Sebagai Pemilik</h4>
            ...
            if (isset($_POST["daftar"])) {
                ...
                $ambil = $conn->query("SELECT * FROM pemilik WHERE email_pemilik = '$email' ");
                ...
                if ($cocok == 1) {
                    ...
                    $conn->query("INSERT INTO pemilik (nama_pemilik,password_pemilik,email_pemilik,no_pemilik) VALUES ('$nama','$password','$email','$telp')");
