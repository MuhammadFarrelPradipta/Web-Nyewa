          ...
          <div class="modal fade" id="staticBackdrops" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <img src="../img/2.png" alt="" style="width: 100px; height: 100px;">
                  <a href="./daftar.php" style="text-decoration: none; color:black;">Pencari</a>
                </div>
                <div class="modal-body">
                  <img src="../img/3.jpg" alt="" style="width: 100px; height: 100px;">
  ...
  <div class="container my-5 p-4 border border-primary" style="background-color: #e3f2fd;">
    <form action="" method="post">
      <div class="login row justify-content-md-center">
        <h4 class="text-center">Masuk Sebagai Pencari</h4>
        <div class="col-md-8">
    ...
    if (isset($_POST['masuk'])) {
      ...
      $ambil = $conn->query("SELECT * FROM pencari WHERE email_pencari = '$email' AND password_pencari = '$password'");
      $akun = $ambil->num_rows;
      if ($akun == 1) {
        $akuns = $ambil->fetch_assoc();
        $_SESSION['pencari'] = $akuns;
